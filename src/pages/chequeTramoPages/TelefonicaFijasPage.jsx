...
// Componente de página para Telefónica Líneas Móviles (ejemplo)
const TelefonicaFijasPage = () => {
  const navigate = useNavigate();
  
  // Columnas de la tabla
  const columns = [
    { id: 'id', label: 'ID', minWidth: 80 },
    { id: 'referencia', label: 'Referencia', minWidth: 120 },
    { id: 'razonsocial', label: 'Razon Social', minWidth: 150 },
    { id: 'domicilio', label: 'Domicilio', minWidth: 200 },
...
export default TelefonicaFijasPage;
